...
// 	protoc        v3.20.1
// source: execution_completed.proto
...
func (ExpectationType) Descriptor() protoreflect.EnumDescriptor {
	return file_execution_completed_proto_enumTypes[0].Descriptor()
}

func (ExpectationType) Type() protoreflect.EnumType {
	return &file_execution_completed_proto_enumTypes[0]
}
...
func (ExpectationType) EnumDescriptor() ([]byte, []int) {
	return file_execution_completed_proto_rawDescGZIP(), []int{0}
}
...
func (ExpectationError) Descriptor() protoreflect.EnumDescriptor {
	return file_execution_completed_proto_enumTypes[1].Descriptor()
}

func (ExpectationError) Type() protoreflect.EnumType {
	return &file_execution_completed_proto_enumTypes[1]
}
...
func (ExpectationError) EnumDescriptor() ([]byte, []int) {
	return file_execution_completed_proto_rawDescGZIP(), []int{1}
}
...
func (Result) Descriptor() protoreflect.EnumDescriptor {
	return file_execution_completed_proto_enumTypes[2].Descriptor()
}

func (Result) Type() protoreflect.EnumType {
	return &file_execution_completed_proto_enumTypes[2]
}
...
func (Result) EnumDescriptor() ([]byte, []int) {
	return file_execution_completed_proto_rawDescGZIP(), []int{2}
}
...
func (x *ExpectationEvaluationError) Reset() {
	*x = ExpectationEvaluationError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_execution_completed_proto_msgTypes[0]
...
func (x *ExpectationEvaluation) Reset() {
	*x = ExpectationEvaluation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_execution_completed_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *ExpectationEvaluations) Reset() {
	*x = ExpectationEvaluations{}
	if protoimpl.UnsafeEnabled {
		mi := &file_execution_completed_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type AgentCheckResult struct {
	...
	// TODO: better type?
	Facts map[string]*anypb.Any `protobuf:"bytes,3,rep,name=facts,proto3" json:"facts,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *AgentCheckResult) Reset() {
	*x = AgentCheckResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_execution_completed_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AgentCheckResult) Descriptor() ([]byte, []int) {
	return file_execution_completed_proto_rawDescGZIP(), []int{3}
}
...
func (x *AgentCheckResult) GetFacts() map[string]*anypb.Any {
	if x != nil {
		return x.Facts
	}
	return nil
...
func (x *ExpectationResult) Reset() {
	*x = ExpectationResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_execution_completed_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExpectationResult) Descriptor() ([]byte, []int) {
	return file_execution_completed_proto_rawDescGZIP(), []int{4}
}
...
func (x *CheckResult) Reset() {
	*x = CheckResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_execution_completed_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CheckResult) Descriptor() ([]byte, []int) {
	return file_execution_completed_proto_rawDescGZIP(), []int{5}
}
...
func (x *ExecutionCompleted) Reset() {
	*x = ExecutionCompleted{}
	if protoimpl.UnsafeEnabled {
		mi := &file_execution_completed_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExecutionCompleted) Descriptor() ([]byte, []int) {
	return file_execution_completed_proto_rawDescGZIP(), []int{6}
}
...
var File_execution_completed_proto protoreflect.FileDescriptor

var file_execution_completed_proto_rawDesc = []byte{
	0x0a, 0x19, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x6f, 0x6d, 0x70,
	0x6c, 0x65, 0x74, 0x65, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x10, 0x74, 0x72, 0x65,
	0x6e, 0x74, 0x6f, 0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x2e, 0x76, 0x31, 0x1a, 0x19, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x61,
	0x6e, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x82, 0x01, 0x0a, 0x1a, 0x45, 0x78, 0x70,
	0x65, 0x63, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x69,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x36, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x22, 0x2e, 0x74, 0x72, 0x65, 0x6e, 0x74, 0x6f, 0x2e, 0x63, 0x68, 0x65,
	0x63, 0x6b, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x45, 0x78, 0x70, 0x65, 0x63, 0x74, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xe5, 0x01,
	0x0a, 0x15, 0x45, 0x78, 0x70, 0x65, 0x63, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x76, 0x61,
	0x6c, 0x75, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x25, 0x0a, 0x0d, 0x6e,
	...
	,
	...
	,
	...
	0x01, 0x22, 0x76, 0x0a, 0x11, 0x45, 0x78, 0x70, 0x65, 0x63, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
	...
	0x6c, 0x74, 0x22, 0xc8, 0x01, 0x0a, 0x12, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e,
	0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x65, 0x78, 0x65,
	...
	,
}

var (
	file_execution_completed_proto_rawDescOnce sync.Once
	file_execution_completed_proto_rawDescData = file_execution_completed_proto_rawDesc
)

func file_execution_completed_proto_rawDescGZIP() []byte {
	file_execution_completed_proto_rawDescOnce.Do(func() {
		file_execution_completed_proto_rawDescData = protoimpl.X.CompressGZIP(file_execution_completed_proto_rawDescData)
	})
	return file_execution_completed_proto_rawDescData
}

var file_execution_completed_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_execution_completed_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_execution_completed_proto_goTypes = []interface{}{
	...
	nil,                                // 10: trento.checks.v1.AgentCheckResult.FactsEntry
	(*anypb.Any)(nil),                  // 11: google.protobuf.Any
}
var file_execution_completed_proto_depIdxs = []int32{
	...
	10, // 5: trento.checks.v1.AgentCheckResult.facts:type_name -> trento.checks.v1.AgentCheckResult.FactsEntry
	...
	11, // 12: trento.checks.v1.AgentCheckResult.FactsEntry.value:type_name -> google.protobuf.Any
...
func init() { file_execution_completed_proto_init() }
func file_execution_completed_proto_init() {
	if File_execution_completed_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_execution_completed_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_execution_completed_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_execution_completed_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_execution_completed_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_execution_completed_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_execution_completed_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_execution_completed_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_execution_completed_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*ExpectationEvaluation_NumericValue)(nil),
		(*ExpectationEvaluation_BooleanValue)(nil),
		(*ExpectationEvaluation_StringValue)(nil),
	}
	file_execution_completed_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_execution_completed_proto_rawDesc,
			NumEnums:      3,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_execution_completed_proto_goTypes,
		DependencyIndexes: file_execution_completed_proto_depIdxs,
		EnumInfos:         file_execution_completed_proto_enumTypes,
		MessageInfos:      file_execution_completed_proto_msgTypes,
	}.Build()
	File_execution_completed_proto = out.File
	file_execution_completed_proto_rawDesc = nil
	file_execution_completed_proto_goTypes = nil
	file_execution_completed_proto_depIdxs = nil
}

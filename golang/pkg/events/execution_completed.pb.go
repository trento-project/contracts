...
type AgentCheckResult struct {
	...
	// TODO: better type?
	Facts map[string]*any1.Any `protobuf:"bytes,3,rep,name=facts,proto3" json:"facts,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *AgentCheckResult) GetFacts() map[string]*any1.Any {
	if x != nil {
		return x.Facts
	}
	return nil

defmodule Trento.Events.Checks.V1.Wanda.FactsGatheringRequested do
  use Ecto.Schema
  ...
  @version "v1"
  @source "trento/wanda"
  @event_type "trento.checks.v1.wanda.FactsGatheringRequested"
  @moduledoc false
  @primary_key false
  ...
  embedded_schema do
    [
      ...
      embeds_many(:facts, Facts, primary_key: false) do
        @derive Jason.Encoder
        @required_fields [:agent_id, :facts]
        import PolymorphicEmbed

...
func (e *ExecutionRequestedV1) Valid() error {
	schema, err := validator.GetSchema("schemas/trento.checks.v1.web.ExecutionRequested.schema.json")
	if err != nil {
		return err
	}
...
func (e *ExecutionRequestedV1) Source() string {
	return "trento/web"
}


func (e *ExecutionRequestedV1) Type() string {
	return "trento.checks.v1.web.ExecutionRequested"
}
